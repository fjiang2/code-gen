...
namespace Sys.Data.Coding
{
    public class Expression : IQueryScript
    {
        ...
        public Expression BETWEEN(Expression exp1, Expression exp2) => this.AffixSpace($"BETWEEN {exp1} AND {exp2}");
        ...
        public Expression NOT(Expression exp) => this.Append($"NOT {exp}");
